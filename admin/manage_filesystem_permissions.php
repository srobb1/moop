...
$permission_items = [
    ...
    [
        ...
        'type' => 'directory',
        'paths' => [$config->getPath('jbrowse2.genomes_directory')],
        'required_perms' => '2775',
        'required_owner' => $moop_owner,
        'required_group' => $web_group,
    ...
    [
        ...
        'type' => 'directory',
        'paths' => [$config->getPath('jbrowse2.tracks_directory')],
        'required_perms' => '2775',
        'required_owner' => $moop_owner,
        'required_group' => $web_group,
    ...
    [
        ...
        'type' => 'directory',
        'paths' => [$config->getPath('jbrowse2.certs_directory')],
        'required_perms' => '750',
        'required_owner' => $moop_owner,
        'required_group' => $web_group,
    ...
    [
        ...
        'type' => 'file',
        'paths' => [
            $config->getPath('jbrowse2.jwt_private_key'),
            $config->getPath('jbrowse2.jwt_public_key'),
        ],
        'required_perms' => '640',
        'required_owner' => $moop_owner,
        'required_group' => $web_group,
