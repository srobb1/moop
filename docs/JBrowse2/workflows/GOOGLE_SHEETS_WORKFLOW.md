...
1. **Runs `setup_jbrowse_assembly.sh`**
   ...
   - Symlinks `genes.gff` → `annotations.gff3`
...
cp genes.gff /data/moop/organisms/New_organism/Assembly1/
...
└── genes.gff        ← Annotations (OPTIONAL but recommended)
```
...
✗ Organism directory not found: /data/moop/organisms/New_organism/Assembly1
  ...
  - /data/moop/organisms/New_organism/Assembly1/genes.gff (optional)
```
...
mkdir -p /data/moop/organisms/New_organism/Assembly1
cp genome.fa /data/moop/organisms/New_organism/Assembly1/
cp genes.gff /data/moop/organisms/New_organism/Assembly1/  # optional
```
...
1. `genes.gff` exists in organisms directory
...
cp ~/downloads/genes.gff organisms/Amphimedon_queenslandica/Aqu1/genes.gff
