...
**Phase 1 (Immediate):** retrieve_selected_sequences.php
- Simplest to implement
- Validate that template approach works with forms
- Catches any unexpected issues early

**Phase 2 (Next):** retrieve_sequences.php
- Medium complexity
- More complex form state
- Build confidence with first conversion

**Phase 3 (Final):** blast.php
- Most complex
- Heavy JavaScript
- Large refactoring, but with pattern established
