...
const RESULTS_HELP = `<strong>Understanding Your Search Results</strong><br><br><strong>What are Features vs. Annotations?</strong><br>A <strong>feature</strong> is a sequence — a gene, mRNA, or protein. Its <strong>annotations</strong> are the descriptions attached to it, and a single feature can have many. That is why the two counts below can differ.<br><br><strong>Result Counts:</strong><br>At the top of each organism's results, you'll see two counters:<br>• <strong>Feature Count:</strong> The number of unique sequences/genes that matched your search<br>• <strong>Annotation Match Count:</strong> The total number of annotations found. If a single feature has multiple matching annotations, each counts separately. This is why the annotation match count may be much higher than the feature count.<br><br><strong>Example:</strong> If your search finds 5 genes, but one gene has 3 matching annotations and another has 2 matching annotations, you'll see 5 features and 7 annotation matches.<br><br><strong>Note:</strong> Horizontal scrolling may be necessary to view the complete table when viewing expanded results.<br><br><strong>Results Limit:</strong><br>MOOP returns a maximum of ${RESULTS_CAP} results per organism due to performance. If you receive exactly ${RESULTS_CAP} results, you may have more matches that aren't shown. Try refining your search with more specific terms or by selecting fewer organisms to see additional results.<br><br><strong>Sorting by Significance:</strong><br>Results are automatically sorted by relevance (significance):<ul><li>Matches in the sequence name or description rank higher (more specific)</li><li>Matches in annotations rank lower (less specific, but still relevant)</li><li>Exact phrase matches rank higher than partial matches</li><li>Matches at the start of a word rank higher than matches in the middle</li></ul>You can click any column header to sort by that column instead, allowing you to re-rank results after applying filters.<br><br><strong>View Modes:</strong><br><strong>Simple View:</strong> Shows a unique list of feature/sequence IDs that matched your search. Each feature appears only once, providing an overview of all matching features without duplication.<br><strong>Expanded View:</strong> Shows all annotations for each matching feature, with the search terms highlighted. This lets you see every annotation that matched your search terms.<br><br><strong>Filter Results:</strong><br>Use the search boxes above each column header to filter results. Type to narrow down results by specific values.<br><br><strong>Expand All Matches:</strong><br>Click the "Expand All Matches" button to expand all rows and view detailed information for each result at once.<br><br><strong>Select and Export:</strong><br>Use the checkboxes to select specific rows, then click export buttons at the bottom:<br>• <strong>Copy:</strong> Copy selected rows to clipboard<br>• <strong>CSV:</strong> Download as comma-separated values file<br>• <strong>Excel:</strong> Download as Excel spreadsheet<br>• <strong>PDF:</strong> Download as PDF document<br>• <strong>Print:</strong> Print selected results<br><br><strong>Column Visibility:</strong><br>Click the "Column Visibility" button to show or hide specific columns based on your needs.<br><br><strong>View Details:</strong><br>Click on any gene or annotation link to view detailed information on the gene/parent feature page.`;
