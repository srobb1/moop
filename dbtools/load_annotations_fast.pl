...
Required arguments:
  ...
  annotations.tsv     Annotation data TSV file with MOOP metadata headers

annotations.tsv format (with metadata headers):
  ## Annotation Source: <database_name>
  ## Annotation Source Version: <version_or_date>
  ## Annotation Source URL: <database_url>
  ## Annotation Accession URL: <accession_url_prefix>
...
usage("Annotation file does not exist: $annot_file") unless -e $annot_file;
usage("Annotation file is not readable: $annot_file") unless -r $annot_file;
