...
echo render_display_page(
    ...
    [
        ...
        'siteTitle'               => $siteTitle,
        // scope-selected-panel BEFORE moopmart.js: moopmart.js calls initScopeSelectedPanel().
        'page_script'             => ["/$site/js/modules/scope-selected-panel.js",
                                      "/$site/js/modules/moopmart.js"],
        'inline_scripts'          => [
