<?php
/**
 * JavaScript Function Registry Display Content
 * Displays the JavaScript function registry with search, filter, and update capabilities
 */

$config = ConfigManager::getInstance();
$docs_path = $config->getPath('docs_path');
$html_registry = $docs_path . '/js_function_registry.html';
