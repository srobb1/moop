...
-rw-r--r--  FASTA files</code></pre>
    ...
    <div class="card mb-4">
      <div class="card-body">
        <p><strong>Where:</strong> <strong>Admin → Manage Organisms</strong> — use the <strong>Update Tree</strong> button</p>

        <p><strong>Purpose:</strong> Makes the organism discoverable on the homepage tree selector.</p>

        <p><strong>How it works:</strong></p>
        <ul>
          <li>The system queries NCBI using the organism's <code>taxon_id</code> and rebuilds the taxonomy tree automatically</li>
          <li>All organisms with a valid <code>taxon_id</code> in their <code>organism.json</code> are inserted at the correct position in the hierarchy</li>
          <li>Run Update Tree any time you add a new organism or change a <code>taxon_id</code></li>
        </ul>
  ...
  "in_use": true
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <p><strong>Generated by:</strong> <strong>Update Tree</strong> button on the <strong>Manage Organisms</strong> admin page</p>
