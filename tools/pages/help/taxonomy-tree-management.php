  ...
  │   │   │           └── Species (Organism 3)</pre>
      ...
      <div class="card shadow-sm border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <p class="text-muted mb-3">
            The tree is automatically generated from organism metadata:
          </p>
          <ul class="text-muted">
            <li>MOOP reads metadata from all organisms in the database</li>
            <li>Each organism has taxonomic information (Kingdom, Phylum, Class, Order, Family, Genus, Species)</li>
            <li>The system builds a hierarchical tree structure from this metadata</li>
          ...
          <ol class="text-muted">
            ...
            <li>Click "Generate Tree from Metadata"</li>
            <li>The system will scan all organisms and rebuild the tree</li>
            <li>You'll see confirmation with the number of organisms found</li>
          </ol>
  ...
  "children": [
    {
      ...
      <div class="card shadow-sm border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <ul class="text-muted">
            <li><strong>Keep metadata current:</strong> Ensure organism metadata is accurate and complete</li>
      ...
      <div class="card shadow-sm border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <p class="text-muted mb-3">
            Check that organism metadata files are properly formatted and contain required taxonomic information. Verify organisms have been loaded into the database.
          </p>
