...
$html .= "<input type=\"text\" id=\"searchInput\" placeholder=\"🔍 Search...\" onkeyup=\"filterSearch()\">\n";
$html .= "</div>\n";
$html .= "<div style=\"display: flex; gap: 20px; flex-wrap: wrap; padding: 10px; background: #f9f9f9; border-radius: 4px;\">\n";
$html .= "<label style=\"display: flex; align-items: center; gap: 8px; cursor: pointer;\">\n";
$html .= "<input type=\"radio\" name=\"searchMode\" value=\"all\" checked onchange=\"filterSearch()\" style=\"cursor: pointer;\">\n";
$html .= "<span>Search All</span>\n";
$html .= "</label>\n";
$html .= "<label style=\"display: flex; align-items: center; gap: 8px; cursor: pointer;\">\n";
$html .= "<input type=\"radio\" name=\"searchMode\" value=\"name\" onchange=\"filterSearch()\" style=\"cursor: pointer;\">\n";
$html .= "<span>Function Names Only</span>\n";
$html .= "</label>\n";
$html .= "<label style=\"display: flex; align-items: center; gap: 8px; cursor: pointer;\">\n";
$html .= "<input type=\"radio\" name=\"searchMode\" value=\"code\" onchange=\"filterSearch()\" style=\"cursor: pointer;\">\n";
$html .= "<span>Code Only</span>\n";
$html .= "</label>\n";
$html .= "<label style=\"display: flex; align-items: center; gap: 8px; cursor: pointer;\">\n";
$html .= "<input type=\"radio\" name=\"searchMode\" value=\"comment\" onchange=\"filterSearch()\" style=\"cursor: pointer;\">\n";
...
$html .= "      const funcCode = item.querySelector('.function-details') ? item.querySelector('.function-details').textContent.toLowerCase() : '';\n";
